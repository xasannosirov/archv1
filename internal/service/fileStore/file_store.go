...
func (f *FilesStoreService) ListFolder(ctx context.Context, filter entity.Filter, lang string) (entity.ListFolderResponse, error) {
	return f.fileStoreRepo.ListFolder(ctx, filter, lang)
}

func (f *FilesStoreService) GetFolder(ctx context.Context, folderID int, lang string) (entity.GetFolderResponse, error) {
	return f.fileStoreRepo.GetFolder(ctx, folderID, lang)
}
...
func (f *FilesStoreService) ListFile(ctx context.Context, filter entity.Filter, lang string) (entity.ListFileResponse, error) {
	return f.fileStoreRepo.ListFile(ctx, filter, lang)
}

func (f *FilesStoreService) GetFile(ctx context.Context, fileID int, lang string) (entity.GetFileResponse, error) {
	return f.fileStoreRepo.GetFile(ctx, fileID, lang)
}
