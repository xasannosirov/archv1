...
func (u *UserUseCase) Delete(ctx context.Context, userID, deletedBy int) (entity.DeleteUserResponse, error) {
	userResponse, err := u.userService.Delete(ctx, userID, deletedBy)
	if err != nil {
